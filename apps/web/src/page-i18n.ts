...
export const pageText = {
  zh: {
    ...
    knowledgeTitle: "知识库与索引治理", knowledgeIntro: "查看知识库目录、重建进度、图谱结构建议和双代索引运行状态。",
    ...
    scheduler: "调度器", cache: "检索缓存", warnings: "治理告警", cleanup: "清理状态", rollback: "回滚到上一代", noWarnings: "无治理告警",
    ...
    evaluationTitle: "RAG 评测对比", evaluationIntro: "基于当前知识库运行评测，比较各 profile 指标并检查逐题证据。", runEvaluation: "运行评测", noEvaluations: "暂无评测记录", history: "评测历史", profileMetrics: "Profile 指标", cases: "评测用例", successRate: "成功率", sourceHitRate: "来源命中率", graphCoverage: "图谱路径覆盖率", latency: "平均耗时", qualityScore: "质量分", recommendation: "建议", error: "错误", answer: "答复", metrics: "指标", questionSet: "题集摘要",
  },
  en: {
    refresh: "Refresh", loading: "Loading…", permission: "Index management permission required", details: "Details",
    knowledgeTitle: "Knowledge Base & Index Governance", knowledgeIntro: "Inspect source directories, rebuild progress, graph schema suggestions, and dual-generation index status.",
    ...
    scheduler: "Scheduler", cache: "Retrieval cache", warnings: "Governance warnings", cleanup: "Cleanup", rollback: "Roll back to previous generation", noWarnings: "No governance warnings",
